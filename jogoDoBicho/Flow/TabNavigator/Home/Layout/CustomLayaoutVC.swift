...
class CustomLayaoutVC: UIViewController {
    
    private let collectionView = UICollectionView(frame: .zero, collectionViewLayout: UICollectionViewFlowLayout())
    private let layout = CustomLayout()
    let images: [UIImage] = [UIImage(named: "africaImg")!, UIImage(named: "eathImg")!, UIImage(named: "canadaImg")!]
    var itemW : CGFloat {
...
extension CustomLayaoutVC: UICollectionViewDataSource {
...
extension CustomLayaoutVC: UICollectionViewDelegate {
...
extension CustomLayaoutVC: UICollectionViewDelegateFlowLayout {
