...
class MyWorkVC: UIViewController {
    ...
    func getImageForMatrix(matrix: Matrix) -> UIImage? {
        let imageIdentifier = matrix.name
        let fileURL = getDocumentsDirectory().appendingPathComponent(imageIdentifier)
...
extension MyWorkVC: UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == contentView.inProgressCollection {
            ...
            let userImage = getImageForMatrix(matrix: matrix)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if let image = UIImage(named: "\(matrix.name.lowercased())PixColor") {
            ...
            if let userImage = self.getImageForMatrix(matrix: matrix) {
